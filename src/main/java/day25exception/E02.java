...
public class E02 {
    ...
    //Bir Stirng Array`den index girerek eleman elde edebilmek icin bir method olusturun.
    ...
    public static void getElementFromArray(String []arr,int idx){
     try {
         ...
         System.out.println("Array index`de bir problem meydana geldi.");

         //Exception ile ilgili detaylica teknik mesaj verir.
         e.printStackTrace();

         //Hata mesajini diger mesajlardan ayirmak icin kullaniriz.
         System.err.println("Array index`de bir problem meydana yasandi");
